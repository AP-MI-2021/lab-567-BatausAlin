...
def menu_add_del_mod():
    ...
    adaugare_cheltuieli(lista, '3', '102', '65.23', '15.12.2021', 'intretinere')
    adaugare_cheltuieli(lista, '4', '44', '99.99', '11.12.2021', 'alte cheltuieli')
    adaugare_cheltuieli(lista, '5', '102', '81.23', '15.12.2021', 'canal')
    adaugare_cheltuieli(lista, '6', '102', '15.23', '15.12.2021', 'intretinere')
    adaugare_cheltuieli(lista, '7', '99', '12.21', '17.05.2002', 'intretinere')
    while True:
